...
class ResnetInResneet(nn.Module):
    def __init__(self, num_classes=100):
        ...
        self.residual_pre_conv = nn.Sequential(
            nn.Conv2d(cfg.img_shape[0], base, 3, padding=1),
            nn.BatchNorm2d(base),
            nn.ReLU(inplace=True)
        )
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(cfg.img_shape[0]84, num_classes, kernel_size=3, stride=2), #without this convolution, loss will soon be nan
