...
class Inception_Stem(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.conv1 = nn.Sequential(
            ...
            BasicConv2d(cfg.img_shape[0]2, 32, kernel_size=3, padding=1),
            BasicConv2d(cfg.img_shape[0]2, 64, kernel_size=3, padding=1)
        )
...
class ReductionB(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.branch7x7 = nn.Sequential(
            ...
            BasicConv2d(cfg.img_shape[0]20, 320, kernel_size=3, stride=2, padding=1)
        )
...
class InceptionC(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.branch3x3stack = nn.Sequential(
            ...
            BasicConv2d(cfg.img_shape[0]84, 448, kernel_size=(1, 3), padding=(0, 1)),
        ...
        self.branch3x3a = BasicConv2d(cfg.img_shape[0]84, 256, kernel_size=(3, 1), padding=(1, 0))
        self.branch3x3b = BasicConv2d(cfg.img_shape[0]84, 256, kernel_size=(1, 3), padding=(0, 1))
...
class InceptionResNetA(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.branch3x3stack = nn.Sequential(
            ...
            BasicConv2d(cfg.img_shape[0]2, 48, kernel_size=3, padding=1),
...
class InceptionResNetB(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.reduction1x1 = nn.Conv2d(cfg.img_shape[0]84, 1154, kernel_size=1)
