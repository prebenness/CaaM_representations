...
class InceptionE(nn.Module):
    def __init__(self, input_channels):
        ...
        self.branch3x3_2a = BasicConv2d(cfg.img_shape[0]84, 384, kernel_size=(1, 3), padding=(0, 1))
        self.branch3x3_2b = BasicConv2d(cfg.img_shape[0]84, 384, kernel_size=(3, 1), padding=(1, 0))
        ...
        self.branch3x3stack_3a = BasicConv2d(cfg.img_shape[0]84, 384, kernel_size=(1, 3), padding=(0, 1))
        self.branch3x3stack_3b = BasicConv2d(cfg.img_shape[0]84, 384, kernel_size=(3, 1), padding=(1, 0))
...
class InceptionV3(nn.Module):
    ...
    def __init__(self, num_classes=100):
        super().__init__()
        self.Conv2d_1a_3x3 = BasicConv2d(cfg.img_shape[0], 32, kernel_size=3, padding=1)
        self.Conv2d_2a_3x3 = BasicConv2d(cfg.img_shape[0]2, 32, kernel_size=3, padding=1)
        self.Conv2d_2b_3x3 = BasicConv2d(cfg.img_shape[0]2, 64, kernel_size=3, padding=1)
