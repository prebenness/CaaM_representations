...
import conf.global_config as cfg
...
def get_network(args):
    ...
    if args.net == 'vgg16':
        ...
        net = bagnet18(num_classes=cfg.num_classes)
        ...
        net = resnet34(num_classes=cfg.num_classes)
        ...
        net = resnet18_cbam(num_classes=cfg.num_classes)
    elif args.net == 'resnet18cbam2':
        from models.resnet_cbam2 import ResidualNet
        net = ResidualNet("ImageNet", 18, num_classes=cfg.num_classes, att_type='CBAM')
    elif args.net == 'resnet34cbam2':
        from models.resnet_cbam2 import ResidualNet
        net = ResidualNet("ImageNet", 34, num_classes=cfg.num_classes, att_type='CBAM')
        ...
        for e in range(num_env + 1):
            if (e <= num_env - 1):
                ...
                if args.net == 't2tvit7_ours':
                    model_list.append(T2t_vit_7_feature(num_classes=cfg.num_classes, final_k=variance_opt['final_k']))
                elif args.net == 't2tvit12_ours':
                    model_list.append(T2t_vit_12_feature(num_classes=cfg.num_classes, final_k=variance_opt['final_k']))
                elif args.net == 'resnet18_ours_cbam':
                    model_list.append(ResidualNet(cfg.network_type, 18, num_classes=cfg.num_classes, att_type='CBAM'))
                elif args.net == 'resnet18_ours_cbam_multi':
                    model_list.append(ResidualNet(cfg.network_type, 18, num_classes=cfg.num_classes, att_type='CBAM', split_layer=variance_opt['split_layer']))
                elif args.net == 'resnet34_ours_cbam':
                    model_list.append(ResidualNet(cfg.network_type, 34, num_classes=cfg.num_classes, att_type='CBAM'))
